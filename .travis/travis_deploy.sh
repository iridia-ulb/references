...
# git remote set-branches origin-travis gh-pages
# git fetch origin-travis gh-pages
# git checkout --track -B gh-pages origin-travis/gh-pages
mv --force -t web/ test/testbib.pdf test/testshortbib.pdf
